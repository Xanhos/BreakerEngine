...
struct UIObjectManager
{
    ...
    UIObject* (*Add)(UIObjectManager* manager, UIObject* object); /**< Adds a new UI object to the manager. */
    UIObject* (*GetFromName)(UIObjectManager* manager, const char* name); /**< Retrieves a UI object by name. */
    UIObject* (*GetFromIndex)(UIObjectManager* manager, int index); /**< Retrieves a UI object by index. */
    void (*RemoveFromPointer)(UIObjectManager* manager, UIObject* object); /**< Removes a UI object using a pointer. */
    void (*RemoveFromIndex)(UIObjectManager* manager, int index); /**< Removes a UI object by index. */
    void (*RemoveFromName)(UIObjectManager* manager, char* name); /**< Removes a UI object by name. */
    void (*Update)(UIObjectManager* manager, WindowManager* window); /**< Updates all UI objects in the manager. */
    void (*Render)(UIObjectManager* manager, WindowManager* window); /**< Renders all UI objects in the manager. */
